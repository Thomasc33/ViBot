...
class afkCheck {
    ...
    async endAfk() {
        ...
        //log key
        for (let u of this.keys) {
            this.db.query(`UPDATE users SET ${this.afkInfo.keyLogName} = ${this.afkInfo.keyLogName} + 1 WHERE id = '${u}'`).catch(er => {console.log(`${this.afkInfo.keyLogName} missing from ${this.guild.name} ${this.guild.id}`)})
