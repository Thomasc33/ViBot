...
module.exports = {
    ...
    async execute(message, args, bot, db) {
        ...
        let errored = false
        await db.query(`INSERT INTO warns VALUES ('${member.user.id}', '${message.author.id}', '${reason}')`, (err, rows) => {
            if (err) { message.channel.send(`There was an error: ${err}`); errored = true }
