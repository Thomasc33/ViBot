    ...
    async execute(message, args, bot, db) {
        ...
        confirmReactionCollector.on('collect', async(r, u) => {
            if (r.emoji.name == '✅') {
                ...
                if (operator != 's' && ['cultsLead', 'voidsLead', 'assists', 'parses', 'o3parses', 'feedback', 'o3assists', 'o3feedback', 'o3runs'].includes(logTypes[logIndex])) {
