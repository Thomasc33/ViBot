...
async function unlockChannel(raiderRole, voiceChannel, voiceChannelNumber, isVet, settings, vcCap) {
    if (isVet) {
        await voiceChannel.permissionOverwrites.edit(raiderRole.id, { Connect: true, ViewChannel: true }).catch(r => console.log(r));
...
async function lockChannel(raiderRole, voiceChannel, voiceChannelNumber, isVet, settings) {
    if (isVet) {
        await voiceChannel.permissionOverwrites.edit(raiderRole.id, { Connect: false, ViewChannel: true }).catch(r => console.log(r));
