...
module.exports = {
    ...
    async execute(message, args, bot, db) {
        ...
        response = (await dm.then(c => c.next(null, null, message.author.id))).content;
        embed.addFields({ name: 'Message Link:', value: response })
        await message.author.send({ embeds: [embed] })
