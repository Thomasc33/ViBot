...
const afkKeysToRemove = new Set(['location', 'raidCommandsEmbed', 'raidCommandsMessage', 'raidInfoEmbed', 'raidInfoMessage', 'raidChannelsEmbed', 'raidChannelsMessage'])
...
router.get('/afkchecks', (req, res) => {
    ...
    console.log(`Time to filter: ${t2 - t1}ms`)
    console.log(`Time to filter 2: ${t3 - t2}ms`)
    return res.status(200).json(filteredAfkChecks)
})
