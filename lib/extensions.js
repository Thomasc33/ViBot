...
Discord.GuildMember.prototype.supporterHierarchy = function supporterHierarchy(settings) {
    ...
    if (roleId == roles.supporterTierFive) return 6
    else if (roleId == roles.supporterTierFour) return 5
    else if (roleId == roles.supporterTierThree) return 4
    else if (roleId == roles.supporterTierTwo) return 3
    else if (roleId == roles.supporterTierOne) return 2
    else if (roleId == roles.nitro) return 1
