...
Discord.Role.prototype.supporterHierarchy = function (settings) {
    const { roles } = settings
    switch (this.id) {
        case roles.supporterTierSix: return 6
        case roles.supporterTierFive: return 5
        case roles.supporterTierFour: return 4
        case roles.supporterTierThree: return 3
        case roles.supporterTierTwo: return 2
        case roles.supporterTierOne: return 1
        default: return 0
    }
}
...
Discord.GuildMember.prototype.supporterRoleHierarchy = function (settings) {
    ...
    if (this.roles.cache.has(roles.supporterTierFive)) return roles.supporterTierFive
    if (this.roles.cache.has(roles.supporterTierFour)) return roles.supporterTierFour
    if (this.roles.cache.has(roles.supporterTierThree)) return roles.supporterTierThree
    if (this.roles.cache.has(roles.supporterTierTwo)) return roles.supporterTierTwo
    if (this.roles.cache.has(roles.supporterTierOne)) return roles.supporterTierOne
    return null
}
