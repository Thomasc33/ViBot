...
Discord.Message.prototype.markSuccessful = async function() {
    return await this.react('✅')
}

Discord.ChatInputCommandInteraction.prototype.markSuccessful = async function(msg) {
    return await this.reply({ content: msg, ephemeral: true })
}

Discord.Message.prototype.markFailed = async function() {
    return await this.react(':ring_buoy:')
}

Discord.ChatInputCommandInteraction.prototype.markFailed = async function(msg) {
    return await this.reply({ content: msg, ephemeral: true })
}
