...
async function createConfirmMenuPanel(messageOrInteraction, text, image, confirmButton = Discord.ButtonBuilder, cancelButton = Discord.ButtonBuilder(), messageType, time = MAX_WAIT, deletePanel) {
